		...
		<div id="main-content">
		        ...
		        <table id="systable" class="table table-striped dataTable no-footer">
		            ...
		            <tbody>
		                <tr v-if="config.iTotal" v-for="data in config.datas">
		                    ...
		                    <td align="center">
		                    	<router-link :to="'menu/edit/'+data.id" v-if="role.update" title="Edit" class="btn btn-default">
		    ...
		    <div class="page-footer-fix">
		        <div class="container-fluid">
		            <div class="col-md-6">
		            	<router-link to="menu/store" v-if="role.create" title="Tambah" class="btn-rounded">
